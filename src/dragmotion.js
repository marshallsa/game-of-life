...
/**
 * The distance in pixels that the mouse needs to move after being clicked to start dragging.
 *
 * @type {number}
 */
...
/**
 * A dragging motion that starts where the mouse is clicked and ends at the mouse's current
 * position.
 */
export default class DragMotion {
  ...
  /**
   * Updates the position of the mouse in the dragging motion and returns the delta from the last
   * position. If the mouse hasn't moved past the drag threshold yet, the delta will be [0, 0].
   *
